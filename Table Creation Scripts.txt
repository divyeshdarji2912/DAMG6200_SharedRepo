...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE LANDLORD 
        (LANDLORD_ID VARCHAR2(50) PRIMARY KEY, LANDLORD_FIRST_NAME VARCHAR(50), LANDLORD_LAST_NAME VARCHAR(50),
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE APARTMENT_TYPE 
        (APARTMENT_TYPE_ID VARCHAR2(50) PRIMARY KEY, LOCALITY VARCHAR2(100), APARTMENT_TYPE VARCHAR2(50), NUMBER_OF_ROOMS VARCHAR2(50), NUMBER_OF_BATHS NUMBER(6,2))';
ELSE
    EXECUTE IMMEDIATE 'CREATE TABLE APARTMENT_TYPE 
        (APARTMENT_TYPE_ID VARCHAR2(50) PRIMARY KEY, LOCALITY VARCHAR2(100), APARTMENT_TYPE VARCHAR2(50), NUMBER_OF_ROOMS VARCHAR2(50), NUMBER_OF_BATHS NUMBER(6,2))';
END IF;
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE APARTMENT (APARTMENT_ID VARCHAR2(50), LANDLORD_ID VARCHAR2(50) NOT NULL, APARTMENT_TYPE_ID VARCHAR2(50) NOT NULL, 
        ...
        MONTHLY_RENT NUMBER(38), PRIMARY KEY(APARTMENT_ID), CONSTRAINT F1 FOREIGN KEY(LANDLORD_ID) REFERENCES LANDLORD(LANDLORD_ID), 
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE APARTMENT_UTILITY (UTILITY_ID VARCHAR2(50) NOT NULL, APARTMENT_ID VARCHAR2(50) NOT NULL,
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE EMPLOYEE_APARTMENT (APARTMENT_ID VARCHAR2(10) not null, EMPLOYEE_ID VARCHAR2(10) not null, CONSTRAINT F11 FOREIGN KEY(APARTMENT_ID) REFERENCES APARTMENT(APARTMENT_ID),
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE LEASE_DETAILS (LEASE_ID  VARCHAR2(10) PRIMARY KEY, APARTMENT_ID VARCHAR2(10) not null, 
...
THEN
    ...
    TRANSACTION_DATE DATE, PAYMENT_TYPE VARCHAR2(50), CONSTRAINT F7 FOREIGN KEY(LEASE_ID) references LEASE_DETAILS(LEASE_ID))';
ELSE
    EXECUTE IMMEDIATE 'CREATE TABLE PAYMENT (PAYMENT_ID VARCHAR2(10) PRIMARY KEY, LEASE_ID VARCHAR2(10) NOT NULL, AMOUNT_TRANSFERRED NUMBER(38), 
    TRANSACTION_DATE DATE, PAYMENT_TYPE VARCHAR2(50), CONSTRAINT F7 FOREIGN KEY(LEASE_ID) references LEASE_DETAILS(LEASE_ID))';
END IF;
...
THEN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE MAINTENANCE_REQUESTS (REQUEST_ID VARCHAR2(10) PRIMARY KEY, APARTMENT_ID VARCHAR2(10) NOT NULL, EMPLOYEE_ID VARCHAR2(10) NOT NULL, REQUEST_DATE DATE, 
